...
(function () {
  ...
  const USERS = {
    parizoda: { pw: 'jaxongir+parizoda', view: 'parizoda' },
    jaxongir: { pw: 'jaxongir+parizoda', view: 'jaxongir' },
  };

  /* ---------- STORE: Firebase yoki localStorage ---------- */
  const Store = (function () {
    const BLANK = { lovePercent: null, madeUp: false, madeUpAt: null, photo: null, shart: null, shartAt: null, updatedAt: null };
  ...
  function renderDashboard() {
    ...
    if (!has) {
      ...
      let line;
      if (isInf) line = '\u0411\u0435\u04b3\u0438\u0441\u043e\u0431! \u0421\u0435\u0432\u0433\u0438\u0441\u0438\u043d\u0438\u043d\u0433 \u0447\u0435\u0433\u0430\u0440\u0430\u0441\u0438 \u0439\u045e\u049b. \ud83d\udc97';
      else if (pct >= 85) line = '\u0421\u0435\u043d\u0438 \u0436\u0443\u0434\u0430\u044f\u043c \u049b\u0430\u0442\u0442\u0438\u049b \u044f\u0445\u0448\u0438 \u043a\u045e\u0440\u0430\u0434\u0438! \ud83d\ude0d';
      else if (pct >= 55) line = '\u042e\u0440\u0430\u0433\u0438 \u0441\u0435\u043d\u0438\u043a\u0438, \u0431\u0443 \u0430\u043d\u0438\u049b. \ud83d\udc95';
      else if (pct >= 25) line = '\u0421\u0435\u0432\u0430\u0434\u0438 \u2014 \u0431\u0430\u043b\u043a\u0438 \u0431\u0438\u0440\u043e\u0437 \u044d\u0440\u043a\u0430\u043b\u0430\u043d\u0430\u0451\u0442\u0433\u0430\u043d\u0434\u0438\u0440. \ud83d\ude42';
      else line = '\u0411\u0438\u0440\u043e\u0437 \u0430\u0440\u0430\u0437\u043b\u0430\u0431 \u0442\u0443\u0440\u0433\u0430\u043d \u0431\u045e\u043b\u0438\u0448\u0438 \u043c\u0443\u043c\u043a\u0438\u043d... \u0431\u043e\u0440\u0438\u0431 \u044d\u0440\u043a\u0430\u043b\u0430\u0431 \u049b\u045e\u0439. \ud83e\udd0d';
    ...
    if (d.madeUp) {
      ...
      made.innerHTML = '<span class="ds-ico">\u231b</span> \u00ab\u041a\u0435\u043b, \u044f\u0440\u0430\u0448\u0442\u0435\u043a\u043c\u0438?\u00bb \u2014 \u04b3\u0430\u043b\u0438 \u0436\u0430\u0432\u043e\u0431 \u043a\u0443\u0442\u0438\u043b\u043c\u043e\u049b\u0434\u0430';
    }
    if (shartEl) {
      if (d.shart) {
        shartEl.hidden = false;
        shartEl.innerHTML = '<div class="dsh-label">★ Дон-дон зики — Паризода бажарадиган шарт ★</div>' +
          '<div class="dsh-text">«' + d.shart + '»</div>' +
          (d.shartAt ? '<div class="dsh-time">қабул қилди: ' + fmtTime(d.shartAt) + '</div>' : '');
      } else {
        shartEl.hidden = true;
      }
    }
  ...
  function startDashPoll() {
    ...
    const poll = function () {
      ...
      try { const j = JSON.parse(localStorage.getItem('pj_answers') || 'null'); if (j) renderDashboard(); } catch (e) {}
  ...
  function boot() {
    ...
    if (refresh) refresh.addEventListener('click', function () { renderDashboard(); toast('\ud83d\udd04 \u042f\u043d\u0433\u0438\u043b\u0430\u043d\u0434\u0438'); });
    Store.init(onData);
    window.PJ = { setShart: function (t) { Store.setShart(t); } };
